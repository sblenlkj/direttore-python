...
class InMemoryDatabase:
    ...
    operations: dict[str, tuple[str, dict[str, Any]]] = field(default_factory=dict)
...
class InMemorySession:
    def __init__(self, database: InMemoryDatabase, session_id: int) -> None:
        ...
        self.movements = deepcopy(database.movements)
        self.operations = deepcopy(database.operations)
    ...
    async def commit(self) -> None:
        ...
        self.database.movements = deepcopy(self.movements)
        self.database.operations = deepcopy(self.operations)
