...
class ResourceHolder(ABC):
    ...
    caching, monotonic commit intent, and execution-local saga entries.

    Transaction finalization is infrastructure-specific. Concrete holders
    ...
    async def close(self) -> None:
        """Close resources and reset the holder for reuse."""
